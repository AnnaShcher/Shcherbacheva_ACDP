...
subroutine feval(neqn,t,c,f,coef,ipar)
 ...
 !integer, parameter :: nclust = 16
	...
	real(kind(1.d0)) :: t, c(neqn), f(neqn), coef(40), theta(39) ! coef - temperature and 39 evaporation rates 
...
subroutine initialize_parameters(theta,coef_quad,coef_lin,  &
	...
	real(kind(1.d0)) :: coef(40)
	integer :: ipar(4)
	real(kind(1.d0)) :: theta(39)
...
subroutine get_rate_coefs(theta,coef_quad,coef_lin,coef,K,E,cs)
  ...
  integer, parameter :: nclust=16
	real(kind(1.d0)) :: coef_quad(nclust,nclust,23),coef_lin(23,23,nclust)
	real(kind(1.d0)) :: theta(39),dH(22),dS(22)
	real(kind(1.d0)) :: K(nclust,nclust),E(nclust,nclust),cs(nclust)
	real(kind(1.d0)) :: coef(40), temp
	integer			 ::  i, j
...
!-----------------------------------------------------------
subroutine get_evap_mcmc(theta,E)
	implicit none
	real(kind(1.d0)) :: E(16,16), theta(39)

	! evaporation coefficients
	!  Converting thermodynamics data from temperature 298.15 K to 278 K.
	
	E = 0.d0
	E(1,1) = theta(1)	! 2A -> 1A + 1A
	E(3,1) = theta(2)	! 1A1N -> 1N + 1A
	E(1,3) = E(3,1)
	E(4,1) = theta(3)	! 2A1N -> 1A1N + 1A
	E(1,4) = E(4,1)
	E(3,2) = theta(4)	! 2A1N -> 1N + 2A
	E(2,3) = E(3,2)
	E(5,1) = theta(5)! 3A1N -> 2A1N + 1A
	E(1,5) = E(5,1)
	E(4,2) = theta(6)	! 3A1N -> 1A1N + 2A
	E(2,4) = E(4,2)
	E(5,3) = theta(7)	! 2A2N -> 2A1N + 1N
	E(3,5) = E(5,3)
	E(4,4) = theta(8)	! 2A2N -> 1A1N + 1A1N
	E(7,1) = theta(9)	! 3A2N -> 2A2N + 1A
	E(1,7) = E(7,1)
	E(6,3) = theta(10)	! 3A2N -> 3A1N + 1N
	E(3,6) = E(6,3)
	E(5,4) = theta(11)	! 3A2N -> 2A1N + 1A1N
	E(4,5) = E(5,4)
	E(8,1) = theta(12)	! 4A2N -> 3A2N + 1A
	E(1,8) = E(8,1)
	E(7,2) = theta(13)	! 4A2N -> 2A2N + 2A
	E(2,7) = E(7,2)
	E(6,4) = theta(14)	! 4A2N -> 3A1N + 1A1N
	E(4,6) = E(6,4)
	E(5,5) = theta(15)	! 4A2N -> 2A1N + 2A1N
	E(8,3) = theta(16)	! 3A3N -> 3A2N + 1N
	E(3,8) = E(8,3)
	E(7,4) = theta(17) ! 3A3N -> 2A2N + 1A1N
	E(4,7) = E(7,4)
	E(10,1) = theta(18)	! 4A3N -> 3A3N + 1A
	E(1,10) = E(10,1)
	E(9,3) = theta(19)	! 4A3N -> 4A2N + 1N
	E(3,9) = E(9,3)
	E(8,4) = theta(20)	! 4A3N -> 3A2N + 1A1N
	E(4,8) = E(8,4)
	E(7,5) = theta(21)	! 4A3N -> 2A2N + 2A1N
	E(5,7) = E(7,5)
	E(11,1) = theta(22)	! 5A3N -> 4A3N + 1A
	E(1,11) = E(11,1)
	E(10,2) = theta(23)	! 5A3N -> 3A3N + 2A
	E(2,10) = E(10,2)
	E(9,4) = theta(24)	! 5A3N -> 4A2N + 1A1N
	E(4,9) = E(9,4)
	E(8,5) = theta(25)	! 5A3N -> 3A2N + 2A1N
	E(5,8) = E(8,5)
	E(7,6) = theta(26) ! 5A3N -> 2A2N + 3A1N
	E(6,7) = E(7,6)
	E(11,3) = theta(27)	! 4A4N -> 4A3N + 1N
	E(3,11) = E(11,3)
	E(10,4) = theta(28)	! 4A4N -> 3A3N + 1A1N
	E(4,10) = E(10,4)
	E(7,7) = theta(29)	! 4A4N -> 2A2N + 2A2N
	E(13,1) = theta(30)! 5A4N -> 4A4N + 1A
	E(1,13) = E(13,1)
	E(12,3) = theta(31)	! 5A4N -> 5A3N + 1N
	E(3,12) = E(12,3)
	E(11,4) = theta(32)	! 5A4N -> 4A3N + 1A1N
	E(4,11) = E(11,4)
	E(10,5) = theta(33)	! 5A4N -> 3A3N + 2A1N
	E(5,10) = E(10,5)
	E(8,7) = theta(34)	! 5A4N -> 3A2N + 2A2N
	E(7,8) = E(8,7)
	E(13,3) = theta(35)	! 4A5N -> 4A4N + 1N
	E(3,13) = E(13,3)
	E(15,1) = theta(36)	! 5A5N -> 4A5N + 1A
	E(1,15) = E(15,1)
	E(14,3) = theta(37)	! 5A5N -> 5A4N + 1N
	E(3,14) = E(14,3)
	E(13,4) = theta(38)	! 5A5N -> 4A4N + 1A1N
	E(4,13) = E(13,4)
	E(10,7) = theta(39)	! 5A5N -> 3A3N + 2A2N
	E(7,10) = E(10,7)
